  ...
  return (
    <div className="w-[100%] md:w-[80%] flex flex-col">
      ...
      <div className="w-full flex flex-col items-center justify-center">
        <p className="text-3xl md:text-4xl py-4 text-green-800 w-[75%] px-6 md:px-8">Search any movie</p>
          ...
          <div className="w-[100%] lg:w-[35%] pt-4">
            <div className="m-4 bg-green-100 p-4 rounded-xl">
              <div className="flex justify-between items-center">
                ...
                <button onClick={createPublicList} className="px-2 py-1 rounded-2xl bg-green-400 hover:bg-green-500 transition ease-in-out duration-300">New List</button>
              </div>
                ...
                return(<div key={key} className="p-2 my-2 bg-green-300 rounded-2xl">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex text-xl gap-2">
                            <div className="p-1  rounded-full hover:cursor-pointer hover:bg-green-400 transition ease-in-out delay-300"><IoIosLink onClick={()=>copyToClip(data)}/></div>
            ...
            <div className="m-4 bg-green-100 p-4 rounded-xl">
              <div className="flex justify-between items-center">
                ...
                <button onClick={createPrivateList} className="px-2 py-1 rounded-2xl bg-green-400 hover:bg-green-500 transition ease-in-out duration-300">New List</button>
              </div>
